...
public class CarsWrapper implements Cars, ModelWrapper<Cars> {
	...
	*/
	...
	public int compareTo(com.ys.cert.model.Cars cars) {
	...
	public com.liferay.portal.model.CacheModel<com.ys.cert.model.Cars> toCacheModel() {
		return _cars.toCacheModel();
	}

	public com.ys.cert.model.Cars toEscapedModel() {
		return new CarsWrapper(_cars.toEscapedModel());
	}

	public com.ys.cert.model.Cars toUnescapedModel() {
