...
import com.ys.liferay.cert.NoSuchInventoryException;
import com.ys.liferay.cert.model.Inventory;
import com.ys.liferay.cert.model.impl.InventoryImpl;
import com.ys.liferay.cert.model.impl.InventoryModelImpl;
...
public class InventoryPersistenceImpl extends BasePersistenceImpl<Inventory>
	 ...
	 */
	public Inventory create(InventoryPK inventoryPK) {
	 ...
	 */
	public Inventory remove(InventoryPK inventoryPK)
		throws NoSuchInventoryException, SystemException {
		return remove((Serializable)inventoryPK);
	}
	...
	@Override
	public Inventory updateImpl(com.ys.liferay.cert.model.Inventory inventory,
	...
	protected Inventory toUnwrappedModel(Inventory inventory) {
		...
		inventoryImpl.setProductId(inventory.getProductId());
		inventoryImpl.setProductName(inventory.getProductName());
		inventoryImpl.setProductCode(inventory.getProductCode());
	...
	public Inventory findByPrimaryKey(Serializable primaryKey)
		...
		return findByPrimaryKey((InventoryPK)primaryKey);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Inventory findByPrimaryKey(InventoryPK inventoryPK)
		throws NoSuchInventoryException, SystemException {
		Inventory inventory = fetchByPrimaryKey(inventoryPK);

		if (inventory == null) {
			if (_log.isWarnEnabled()) {
				_log.warn(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + inventoryPK);
			}
	...
	public Inventory fetchByPrimaryKey(Serializable primaryKey)
		throws SystemException {
		return fetchByPrimaryKey((InventoryPK)primaryKey);
	}
		...
		if (inventory == null) {
			...
			try {
				...
				if (inventory != null) {
					...
					EntityCacheUtil.putResult(InventoryModelImpl.ENTITY_CACHE_ENABLED,
						InventoryImpl.class, inventoryPK, _nullInventory);
				}
	...
	public List<Inventory> findAll(int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sql = _SQL_SELECT_INVENTORY.concat(InventoryModelImpl.ORDER_BY_JPQL);
			}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.ys.liferay.cert.model.Inventory")));
